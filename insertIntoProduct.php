...
$product_name = $_POST['product name']; $color_id = $_POST['color id']; $size_id = $_POST['size id']

$sql = "INSERT INTO product (`product name`, `color id`, `size id`) VALUES ('$product_name', '$color_id', '$size_id' )";
